...
The setup script installs Bun, all dependencies, registers 5 Claude Code plugin marketplaces, installs 11 plugins, and creates your `.env` file. After that, fill in your API keys and run `bun run dev`.
